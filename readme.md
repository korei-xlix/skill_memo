...
このリポジトリは、わたしKoreiのIT技術メモです。  
個人的に作った殴り書きメモなので、謝りがあっても補償はしません。  
...
* 【標準規格】
    * [github readme.md テンプレート](/standard/github_template.md)
    * [コーディング規約](/standard/standard.md)

* 【コーディング技術】
    * [SQL技術メモ](/coding/sql.md)
    * [Plant UML技術](/coding/uml.md)
    * [Plant UMLファイル](/coding/uml.pu)
...
* 【古い資料】
    * [postgreSQL技術メモ](/old/postgre_sql.md)
